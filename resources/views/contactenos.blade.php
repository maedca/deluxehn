        ...
        <div class="page-header" id="banner">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    {!! Form::close() !!}
                    <p>GRUPO DI, S.A DE C.V</p>
                    <p>LUNES A VIERNES DE 8:00 - 17:30 HRS.</p>
                    <p>COLONIA ALTIPLANO 25 CALLE 20 AVENIDA N.0-CASA #2,000</p>
                    <P>CIUDAD SAN PEDRO SULA DEPARTAMENTO DE CORTÉS</P>
                    <p>TEL. +504 2505-3601 / 9445-0599</p>
                    <p>CEL. </p>
